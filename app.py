...
def fertilizer_recommend():
    ...
    abs_n_desired = N_desired
    abs_p_desired = P_desired
    abs_k_desired = K_desired
    ...
    return render_template('Fertilizer-Result.html', recommendation1=response1,
                           ...
                           diff_n = abs_n, diff_p = abs_p, diff_k = abs_k , des_n=abs_n_desired,des_p=abs_p_desired,des_k=K_desired)
